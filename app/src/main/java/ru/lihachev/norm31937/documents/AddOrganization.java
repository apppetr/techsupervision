    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnContinue).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                organization.name = AddOrganization.this.etOrganizationTitle.getText().toString();

                if (!TextUtils.isEmpty(AddOrganization.this.etOrganizationYear.getText())) {
                    organization.year = Integer.valueOf(AddOrganization.this.etOrganizationYear.getText().toString()).intValue();
                }
                organization.address = AddOrganization.this.etOrganizationAddress.getText().toString();

                organization.date = System.currentTimeMillis();

                CupboardFactory.cupboard().withContext(AddOrganization.this).put(UserDataProvider.getContentUri(UserDataHelper.ORGANIZATION_URL), organization);
                finish();
