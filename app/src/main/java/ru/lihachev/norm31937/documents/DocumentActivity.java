...
public class DocumentActivity extends ToolbarActivity implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener, RequestPermissionCallback {
   ...
   private static final String SORT = "ru.lihachev.norm31937.SORT";
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      this.document = (Document) CupboardFactory.cupboard().withContext(this).get(ContentUris.withAppendedId(UserDataProvider.getContentUri(UserDataHelper.DOCUMENT_URL), savedInstanceState == null ? getIntent().getLongExtra("ru.lihachev.norm31937.DOCUMENT_ID", -1) : savedInstanceState.getLong("ru.lihachev.norm31937.DOCUMENT_ID", -1)), Document.class);
   ...
   public void onSaveInstanceState(Bundle outState) {
      ...
      outState.putLong("ru.lihachev.norm31937.DOCUMENT_ID", this.document._id.longValue());
   }

   public void onAddClick(View view) {
      Intent intent = new Intent(this, AddDefectActivity.class);
      intent.putExtra("ru.lihachev.norm31937.DOCUMENT_ID", this.document._id.intValue());
   ...
   public void onClick(@NonNull View view) {
      switch (view.getId()) {
         ...
         case R.id.tvEdit /*2131558575*/:
            ...
            intentEdit.putExtra("ru.lihachev.norm31937.DOCUMENT_ID", this.document._id.intValue());
