...
public class ValuesProvider extends ContentProvider {
    public static String AUTHORITY = "ru.lihachev.norm31937.free.PROPERTIES";
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matcher.match(uri)) {
            ...
            case VALUES_REASONS_URI_FORSELECTION_CONTENT /*12306*/:
                Cursor c = this.dbHelper.getReadableDatabase().rawQuery(String.format(Values.Reasons.RAW_QUERY, selection) + (TextUtils.isEmpty(sortOrder) ? "" : " order by " + sortOrder), (String[]) null);
                c.setNotificationUri(this.contentResolver, uri);
                return c;
            case VALUES_COMPENSATIONS_URI_FORSELECTION_CONTENT /*12322*/:
                SQLiteDatabase readableDatabase = this.dbHelper.getReadableDatabase();
                StringBuilder append = new StringBuilder().append(String.format(Values.Compensations.RAW_QUERY, selection));
