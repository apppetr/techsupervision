...
public class UserDataHelper extends SQLiteOpenHelper {
   ...
   /* renamed from: ru.sviridov.techsupervision.db.UserDataHelper$DEFECT_WITH_PICTURE */
   ...
   /* renamed from: ru.sviridov.techsupervision.db.UserDataHelper$DOCUMENT_WITH_DEFECTS */
