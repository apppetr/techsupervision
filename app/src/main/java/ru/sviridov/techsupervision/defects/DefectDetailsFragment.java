   ...
   public void onViewCreated(View view, Bundle savedInstanceState) {
      ...
      llReason.setOnClickListener(new View.OnClickListener() {
         public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), SelectVariantsActivity.class);
            intent.putExtra(SelectVariantsActivity.ROOTS, Formats.extractIds(DefectDetailsFragment.this.defect.problems));
            intent.putExtra(SelectVariantsActivity.ROOTS_STRING, DefectDetailsFragment.this.defect.getNiceProblems());
            intent.putExtra(SelectVariantsActivity.SELECTED_VALUES, Formats.extractIds(DefectDetailsFragment.this.defect.reasons));
      ...
      llCompensations.setOnClickListener(new View.OnClickListener() {
         public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), SelectVariantsActivity.class);
            intent.putExtra(SelectVariantsActivity.ROOTS, Formats.extractIds(DefectDetailsFragment.this.defect.reasons));
            intent.putExtra(SelectVariantsActivity.ROOTS_STRING, DefectDetailsFragment.this.defect.getNiceReasons());
            intent.putExtra(SelectVariantsActivity.SELECTED_VALUES, Formats.extractIds(DefectDetailsFragment.this.defect.compensations));
